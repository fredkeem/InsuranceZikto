...
(function(f, g) {
  "object" === typeof exports
    ? (module.exports = g("Pageable"))
    : "function" === typeof define && define.amd
    ? define([], g)
    : (f.Pageable = g("Pageable"));
})(
  ...
  function() {
    ...
    h.prototype.stop = function() {
      this.running &&
        ...
        (this.running = this.instance.slideInterval = !1));
    };
    var d = function(a, c) {
      if (void 0 === a)
      ...
      var b = this,
        e = {
          ...
          slideshow: !1,
          infinite: !1,
          events: { wheel: !0, mouse: !0, touch: !0 }
        };
      ...
      this.pages.forEach(function(a, c) {
        var e = a.dataset.anchor.replace(/\s+/, "-").toLowerCase();
        a.id !== e && (a.id = e);
        b.anchors.push("#" + e);
    ...
    d.prototype.init = function() {
      if (!this.initialised && !this.container.pageable) {
        ...
        ["Prev", "Next"].forEach(function(b) {
          ...
          a[b] &&
            ("string" === typeof a[b]
              ? (this[b] = document.querySelector(a[b]))
              : a[b] instanceof Element && (this[b] = a[b]),
            this[b] && this[b].classList.add("pg-nav"));
        }, this);
        if (a.pips) {
        ...
        a.slideshow &&
          "function" === typeof h &&
          ((this.slider = new h(this)), this.slider.start());
      }
    };
    d.prototype.bind = function() {
      this.callbacks = {
        wheel: this._wheel.bind(this),
        update: k(this.update.bind(this), this.config.throttle),
    ...
    d.prototype.update = function() {
      ...
      this.config.infinite &&
        this.clones.forEach(function(b) {
          this.horizontal && (b.style["float"] = "left");
          b.style[a] = this.data.window[a] + "px";
          b.style[c] = this.data.window[c] + "px";
        }, this);
      ...
      if (this.initialised) {
        ...
        ["Prev", "Next"].forEach(function(a) {
          ...
          this[a] &&
            ...
            this[a].classList.remove("pg-nav"));
        }, this);
    ...
    d.prototype.emit = function(a) {
      ...
      if (!1 !== a in this.listeners)
        for (var c = 0; c < this.listeners[a].length; c++)
          this.listeners[a][c].apply(this, [].slice.call(arguments, 1));
    };
    d.prototype._click = function(a) {
      if (a.target.closest) {
        var c = a.target.closest("a");
        c &&
          this.anchors.includes(c.hash) &&
          (a.preventDefault(), this.scrollToAnchor(c.hash));
      }
    };
    ...
    d.prototype._start = function(a) {
      ...
      if ("touchstart" === a.type && !this.events.touch)
        return c.target.closest("a") || this._preventDefault(a), !1;
      if (
        ("mousedown" === a.type && (!this.events.mouse || 0 !== a.button)) ||
        !c.target.closest("[data-anchor]")
      )
        return !1;
      this._preventDefault(a);
      this.dragging = this.config.freeScroll;
      this.config.slideshow && this.slider.stop();
      this.down = { x: c.clientX, y: c.clientY };
    ...
    d.prototype._stop = function(a) {
      ...
      var d =
        Math.abs(b[this.mouseAxis[this.axis]] - this.down[this.axis]) >=
        this.config.swipeThreshold;
      d = this.down && d;
      this.config.slideshow && this.slider.start();
      if (this.dragging && !this.scrolling)
        (this.dragging = b = this._limitDrag(b)),
          d &&
            (this.config.infinite && this._overScroll(0 > b, b),
            0 < b ? 0 < c.index && c.index-- : a()),
          this._scrollBy(this._getScrollAmount(this.oldIndex) - b),
          (this.down = !1);
        ...
        d &&
          (this.config.infinite && this._overScroll(f),
          f ? a() : b && 0 < c.index && c.index--);
        this.startIndex === this.index
      ...
      if ((a = location.hash))
        if (((a = this.anchors.indexOf(a)), -1 < a)) {
          this.scrollPosition =
            ...
            (a + (this.config.infinite ? 1 : 0));
          var c = this._getData();
          this.slideIndex = this.index = a;
          this.pages.forEach(function(a, c) {
    ...
    d.prototype._overScroll = function(a) {
      var c =
        ...
        b = this.index;
      b === this.lastIndex && a
        ? (b++, this._scrollBy(-this.data.window[this.size[this.axis]] - c, b))
        : 0 !== b ||
          a ||
          (b--, this._scrollBy(this.data.window[this.size[this.axis]] - c, b));
    };
      ...
      b.timer = setTimeout(
        function() {
          ...
          b.frame = requestAnimationFrame(function l() {
            var e = Date.now() - d;
            if (e > b.config.animation)
              return (
                cancelAnimationFrame(b.frame),
                (b.container.style.transform = ""),
                (b.frame = !1),
                (b.scrolling = !1),
                (b.dragging = !1),
                b.config.slideshow && b.slider.start(),
                b.config.infinite &&
                  (c === b.pageCount
                    ? (b.index = 0)
                    : -1 === c && (b.index = b.lastIndex)),
                (e = b._getData()),
                (window.location.hash = b.pages[b.index].id),
                b.pages.forEach(function(a, c) {
                  a.classList.toggle("pg-active", c === b.index);
                }, b),
                (b.slideIndex = b.index),
                b._setPips(),
                b._setNavs(),
                b.config.onFinish.call(b, e),
                b.emit("scroll.end", e),
                !1
              );
            e = b.config.easing(
              e,
              b.dragging ? b.dragging : 0,
              a,
              b.config.animation
            );
            b.container.style.transform = b.horizontal
    ...
    d.prototype._limitDrag = function(a) {
      ...
      !this.config.infinite &&
        ((0 === this.index && 0 < a) ||
          (this.index === this.pages.length - 1 && 0 > a)) &&
        (a /= 10);
      return a;
    };
    d.prototype._setNavs = function() {
      this.navPrevEl &&
        this.navPrevEl.classList.toggle(
          "active",
          this.config.infinite || 0 < this.index
        );
      this.navNextEl &&
        this.navNextEl.classList.toggle(
          "active",
    ...
    d.prototype._setPips = function(a) {
      this.config.pips &&
        ...
        this.pips.forEach(function(c, b) {
